...
const model_dictionaryPropertycategory = require('../models/es-dictionary-propertycategory');
//
...
module.exports['indexing'] = function(req, res, next) {
  ...
  model_dictionaryPropertycategory.indexing({data:dataIndex, country:req.query.country || 'id', id:dataIndex.text}, function(error,response){
...
module.exports['initMapping'] = function(req, res, next) {
  ...
  const model = model_dictionaryPropertycategory;
...
module.exports['fetchOneById'] = function(req, res, next) {
  ...
  model_dictionaryPropertycategory.fetchOneById({country:country,id:id}, function(e,o){
