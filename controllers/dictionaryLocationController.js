...
const model_dictionaryLocation = require('../models/es-dictionary-location');
//
...
module.exports['indexing'] = function(req, res, next) {
  ...
  const dataIndex = {
    ...
    foreignkey: req.query.foreignkey || req.query.meaning
  }
  ...
  model_dictionaryLocation.indexing({data:dataIndex, country:req.query.country || 'id', id:dataIndex.text}, function(error,response){
...
module.exports['initMapping'] = function(req, res, next) {
  ...
  const model = model_dictionaryLocation;
...
module.exports['fetchOneById'] = function(req, res, next) {
  ...
  model_dictionaryLocation.fetchOneById({country:country,id:id}, function(e,o){
